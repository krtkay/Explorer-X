...
{
	fileFont[0].loadFromFile("arial.ttf");
	fileFont[1].loadFromFile("Roboto-Light.ttf");

	fileIcons[File::Folder].loadFromFile("folder.png");
	fileIcons[File::Other].loadFromFile("file.png");
